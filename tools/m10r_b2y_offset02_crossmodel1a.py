...
def main():
    ...
    result={
      "schema":"M10R_B2Y_OFFSET02_CROSSMODEL1A_V1",
      "record_id":"0x02","selector":"offset",
      ...
      "guardrails":[
        "Key-aware matching supersedes occurrence ordinal for repeated 0x02 records.",
    ...
    L=["# M10-R B2Y OFFSET02 CROSSMODEL1A","",
       "Key-aware cross-model audit of record 0x02 (actual B2Y Offset).","",
       "## Summary","",
    ...
    L += ["","## Next","",
          "Map the key-resolved M10-R payload through driver 0xD3284 and determine the exact output-domain offset fields. Keep renderer frozen.",""]
    a.report.write_text("\n".join(L))
